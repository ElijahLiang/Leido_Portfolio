...
export default function Particles() {
  ...
  useEffect(() => {
    ...
    const solidFaces = (solid, origin, sceneRot, time) => {
      ...
      return defs.map((def) => {
        ...
        return {
          ...
          color: solid.color,
          shade: def.shade,
          alpha: solid.major ? 0.9 : solid.color === palette.white ? 0.54 : 0.74,
    ...
    const drawFace = (face) => {
      ...
      ctx.globalAlpha = face.color === palette.ink ? 0.28 : 0.48;
  ...
  return <canvas id="particle-bg" ref={canvasRef} className="particles-canvas" />;
}
